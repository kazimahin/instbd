...
function AddRoutine(props) {
    ...
    useEffect(()=>{
        ...
        axios.get("/api/web/dash/academic/routine/"+props.id)
            .then(v=>{
    ...
    const handleSubmit = e => {
        ...
        axios.put("/api/web/dash/academic/routine/"+props.id,{...values})
            .then(v=>{
            ...
            <MForm style={{ visibility:loading1 && "hidden"}} onSubmit={handleSubmit}>
                ...
                <Grid container   >
                    ...
                    <Grid item xs={12} sm={12} >
                        <Typography variant="h6" style={{margin:"30px 8px 10px 8px"}} >Details</Typography>
                    </Grid>
