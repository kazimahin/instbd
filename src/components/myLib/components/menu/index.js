...
export  function Mmenu(props) {
  ...
  return (
      <div className={classes.root}>
        ...
        <Popper  open={open} anchorEl={anchorRef.current} style={{zIndex:"100"}} role={undefined} transition disablePortal>
                  ...
                  <MenuList  id="menu-list-grow"  >
                    {
                        props.value.list.map((value,key)=>{
                            return(
                                     <MenuItem style={{padding:"0px"}} key={key}  >{value}</MenuItem>
...
//Menulink function
export  function MmenuLink(props) {
